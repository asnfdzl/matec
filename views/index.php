...
<head>
    ...
    .section-swiper-absoulte {
        position: relative;
        background: url(<?= asset('images/homebck.jpg') ?>) no-repeat center center;
                ...
                <div class="row justify-content-lg-center">
                    <div class="col-lg-10">
                        ...
                        <div class="wow fadeInUp text-spacing-200" data-wow-delay=".8s" data-caption-animate="fadeInUp" data-caption-delay="300" data-caption-duration="900">
                            <img src="<?= asset('images/matec-hero_title-01.png') ?>" alt="ACCELERATE INTO THE" class="img-fluid py-3">
                        </div>
                        <div  class="wow fadeScale mb-3" data-caption-animate="fadeInUp" data-caption-delay="100" data-caption-duration="900">
                            <img src="<?= asset('images/matec-hero_title-02.png') ?>" alt="FUTURE" class="img-fluid py-3">
                        </div>
                                ...
                                <div class="unit-left">
                                    <div class="icon-rect icon-rect-secodanry" data-triangle=".icon-rect-overlay">
                                        ...
                                        <svg class="svg-icon-sm-1" role="img">
                                            <use xlink:href="<?= asset('images/svg/sprite.svg#tick') ?>"></use>
                                        </svg>
                                    </div>
                                </div>
                                <div class="unit-body">
                ...
                <div class="col-md-10 col-lg-5 col-xl-5 text-md-right">
                    ...
                    <div class="images-box">
                        <div class="images-box-item images-box-item-right">
                            <div class="wow fadeScale"><img src="<?= asset('images/vendor1.png') ?>" alt="" width="470" height="590"/>
                            </div>
                        </div>
                        <br><br>
                        <div class="images-box-item images-box-item-right">
                            <div class="wow fadeScale"><img src="<?= asset('images/6.jpg') ?>" alt="" width="470" height="590"/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row row-30 justify-content-center">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide" style="width: 325px;">
                                    <div class="card" style="border: none; text-align: center;">
                                        <img class="card-image" src="<?= asset('images/car.png') ?>" alt="Car Image" style="width: 100px; height: auto; margin: 0 auto;">
                                        <div class="card-body">
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 text-md-right">
                    ...
                    <div class="images-box">
                        <div class="images-box-item images-box-item-right">
                            <div class="wow fadeScale"><img src="<?= asset('images/homeman.png') ?>" alt="" width="470" height="590"/>
                            </div>
                        </div>
                        <div class="images-box-item images-box-item-left">
                            <div class="wow fadeScale"><img src="<?= asset('images/homeman2.png') ?>" alt="" width="270" height="257"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-end">
                    <div class="col-lg-7 text-left">
                        <img src="<?= asset('images/matec1.png') ?>" alt="THE IDEAS OF MATEC" class="img-fluid">
                    </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon1.png') ?>" alt="Activity 1">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon2.png') ?>" alt="Activity 2">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon3.png') ?>" alt="Activity 3">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon4.png') ?>" alt="Activity 4">
                                <div class="card-body">
                ...
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon5.png') ?>" alt="Activity 5">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon6.png') ?>" alt="Activity 6">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon7.png') ?>" alt="Activity 7">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon8.png') ?>" alt="Activity 8">
                                <div class="card-body">
                ...
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon9.png') ?>" alt="Activity 9">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon10.png') ?>" alt="Activity 10">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon11.png') ?>" alt="Activity 11">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 col-lg-3 mb-4">
                            <div class="card activity-card">
                                <img class="card-image" src="<?= asset('images/icon12.png') ?>" alt="Activity 12">
                                <div class="card-body">
            ...
            <div class="row row-ten row-narrow row-30 row-lg-50 justify-content-center" data-lightgallery="group">
                <div class="col-sm-4 col-md-3 col-lg-2">
                    <div class="wow">
                        <div>
                            <!-- Gallery Thumbnail-->
                            <a class="thumbnail" href="<?= asset('images/6.jpg') ?>" data-lightgallery="item" data-triangle=".thumbnail-overlay">
                                <span class="thumbnail-overlay"></span>
                                <span class="thumbnail-icon"></span>
                                <img src="<?= asset('images/6.jpg') ?>" alt="" width="298" height="343"/>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-md-3 col-lg-2">
                    <div class="wow">
                        <div>
                            <!-- Gallery Thumbnail-->
                            <a class="thumbnail" href="<?= asset('images/9.jpg') ?>" data-lightgallery="item" data-triangle=".thumbnail-overlay">
                                <span class="thumbnail-overlay"></span>
                                <span class="thumbnail-icon"></span>
                                <img src="<?= asset('images/9.jpg') ?>" alt="" width="298" height="343"/>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-md-3 col-lg-2">
                    <div class="wow">
                        <div>
                            <!-- Gallery Thumbnail-->
                            <a class="thumbnail" href="<?= asset('images/14.jp') ?>" data-lightgallery="item" data-triangle=".thumbnail-overlay">
                                <span class="thumbnail-overlay"></span>
                                <span class="thumbnail-icon"></span>
                                <img src="<?= asset('images/14.jpg') ?>" alt="" width="298" height="343"/>
                            </a>
                        </div>
                    </div>
                </div>

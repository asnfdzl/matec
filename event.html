...
<div class="rd-navbar-brand">
  <!--Brand--><a class="brand" href="index.html">
      ...
      <img class="brand-logo-light" src="images/logo.png" srcset="images/logo@2x.png 2x" alt="matec" style="width: 600px; height: auto;"/>
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <!--  <li class="rd-nav-item"><a class="rd-nav-link" href="vendor.html">For Vendor</a>-->
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="event.html">About Event</a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="sponsorship.html">Sponsorship</a>
                      </li>
                ...
                <!-- RD Navbar Collapse-->
                <div class="rd-navbar-collapse"><a class="button button-primary" href="#" data-triangle=".button-overlay"><span>Register Now</span><span class="button-overlay"></span></a>
                </div>
              </div>
            </div>
          </nav>
        ...
        <div class="container">
          ...
          <div class="row row-30">
            <div class="col-md-6 col-lg-4">-->
              ...
              <div class="speaker">
                <div class="speaker-img" data-triangle=".speaker-overlay">-->
                  <!-- Gallery Thumbnail<a class="thumbnail" href="images/11.jpg" data-lightgallery="item" data-triangle=".thumbnail-overlay"><span class="thumbnail-overlay"></span><span class="thumbnail-icon"></span><img src="images/11.jpg" alt="" width="298" height="343"/></a>
                </div>
            ...
            <div class="col-md-6 col-lg-4">-->
              ...
              <div class="speaker">
                <div class="speaker-img" data-triangle=".speaker-overlay">-->
                  <!-- Gallery Thumbnail<a class="thumbnail" href="images/12.jpg" data-lightgallery="item" data-triangle=".thumbnail-overlay"><span class="thumbnail-overlay"></span><span class="thumbnail-icon"></span><img src="images/12.jpg" alt="" width="298" height="343"/></a>
                </div>
            ...
            <div class="col-md-6 col-lg-4">-->
              ...
              <div class="speaker">
                <div class="speaker-img" data-triangle=".speaker-overlay">-->
                <!-- Gallery Thumbnail<a class="thumbnail" href="images/13.jpg" data-lightgallery="item" data-triangle=".thumbnail-overlay"><span class="thumbnail-overlay"></span><span class="thumbnail-icon"></span><img src="images/13.jpg" alt="" width="298" height="343"/></a>
                </div>
